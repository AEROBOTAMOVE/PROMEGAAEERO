...
import os as _os
_p=_os.environ.get("MXMOD","live_bot.py")
_sp=_iu.spec_from_file_location("lbx",_p); lb=_iu.module_from_spec(_sp); _sp.loader.exec_module(lb)
import pandas as pd
...
json.dump(изх, io.open("mx_OUT.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
