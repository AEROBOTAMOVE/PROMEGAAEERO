...
#
#   «широк превес» (≥3) срещу «тесен» (≤2):
#     ЛОНГ · всички       +4.206$ [+2.68, +5.70] ✅
#     ЛОНГ · 2004-2014    +5.009$ [+2.43, +7.21] ✅
#     ЛОНГ · 2015-2026    +3.668$ [+1.66, +5.56] ✅
#     🔄 ШОРТ · всички    +2.784$ [+1.12, +4.40] ✅
#   при праг ≥4: ЛОНГ +2.574$ [+1.04,+4.06] · ШОРТ +1.982$ [+0.22,+3.64]
#
# МИНАВА И ТРИТЕ ИЗПИТА, включително двата, които събориха ATR-геометрията:
#   · работи в ДВЕТЕ ПОСОКИ (лонг И шорт)
#   · работи в ДВЕТЕ ЕПОХИ
#   · ПЛАЦЕБО: 0 от 9 разбърквания на превеса излизат чисти
#     (истинският +2.574$ [+1.05,+4.15]; най-доброто разбъркване +0.825$
#      с интервал [−0.01,+1.69] — през нулата)
#
# Затова ТЕСНИЯТ превес получава ПОЛОВИН размер — точно както «под
# 200-дневната» вече го получава. Не се добавя нов вход; само се пази
# по-малко върху мерено по-слабата половина.
