...
ck("П104 при ШОРТ прибраното е същото (+6.50$)", abs(_п104ш - 6.50) < 0.02)
...
ck("П103 при ШОРТ пипсовете са същите, посоката е обратна",
   abs((4650.0 - _с103["tp1"]) - 7.5) < 0.011 and abs((_с103["sl"] - 4650.0) - 20.0) < 0.011)
