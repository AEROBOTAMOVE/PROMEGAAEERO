...
ck("О3 нощен филтър съществува и е САМО при входовете",
   "REOFFER_LO" in _src and "REOFFER_HI" in _src
   and _src.count("_reoffer_hour_ok(now_utc)") == 2)          # злато + сребро, НЕ стоящ сетъп
