...
ck("П117 РЕЖИМЪТ се назовава", "режимът е слаб" in _реже117)
...
ck("П132 изключен · long/day1 и long/stale МИНАВАТ (непокътнати)",
   _изкл132[("long", 1)][0] and _изкл132[("long", 5)][0])
...
try:
    ...
    ck("П132 включен · СМЕНЯ СЕ ТОЧНО ЕДНО решение (%s)" % (_смени132,),
       _смени132 == [("long", 0)])
...
try:
    ...
    ck("П115 строго · истинските числа ПАК минават",
       _lb115._advice_entry("long", 2, _R115, None, False, 0)[1] is True)
finally:
    if _ст115 is None:
