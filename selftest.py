...
ck("П40 «гледай» иска поне СИЛЕН, не ГОТОВ",
   'os.environ.get("МОЗЪК_РАНГ_ВХОД", "4")' in _s40)
...
ck("П58 сребърните клетки наистина нямат интервали",
...
for _д58 in ("long", "short"):
    ...
    ck(f"П58 сребро {_д58} казва ЗАЩО", "не е мерен" in _т58)
