...
ck("П10 при 2/3 се казва колко са против", "1 против" in _c23 and "не е пълно подреждане" in _c23)
...
ck("П10 при 3/3 ИМА ✓ подредено", "3/3 ✓ подредено" in _c33)
...
ck("П10 при 0/3 казва «нищо не подкрепя»", "0/3 ⚠ нищо не подкрепя" in _c03)
...
ck("П12 short/day1 пуска", _g("short", 1)[1])
