...
ck("О4 таванът е на практика махнат (над 100ч)", lb.REOFFER_MAX_AGE_H >= 100)
ck("О4 но НЕ е безкраен — замръзнала дъска не пали вечно",
   lb.REOFFER_MAX_AGE_H <= 2000)
...
ck("О4 и таванът по клетка НЕ е безкраен (стар сетъп пак умира)",
   lb.MAX_AGE_ПРЕСЕН < 10000 and lb._max_age_h("long", 2) <= 1000)
...
ck("П90 таванът е ПО КЛЕТКА, не глобален (основата вече е 240ч)",
   lb.REOFFER_MAX_AGE_H == 240.0 and lb.MAX_AGE_ПРЕСЕН > lb.REOFFER_MAX_AGE_H)
...
ck("П90 прагът НЕ е пипан глобално (той ограничава истински)",
   lb.REOFFER_H == 6.0)
ck("П90 таванът Е вдигнат глобално, мерено", lb.REOFFER_MAX_AGE_H == 240.0)
