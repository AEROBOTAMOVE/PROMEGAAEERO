...
ck("П127 SMA-филтърът е ВКЛЮЧЕН (доказан при двата хоризонта)",
   lb.ЛОНГ_САМО_НАД_SMA200 is True)
ck("П127 петъчният е ИЗКЛЮЧЕН (обосновката падна при вярния хоризонт)",
   lb.БЕЗ_ЛОНГ_ПЕТЪК is False)
ck("П127 лонг под SMA200 се ОТКАЗВА (в делник, без петъчния флаг)",
