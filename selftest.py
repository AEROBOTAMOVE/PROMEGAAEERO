...
ck("П87 COOL_MIN СЪЩЕСТВУВА и е число", isinstance(lb.COOL_MIN, int) and lb.COOL_MIN == 45)
...
ck("П98 таванът е 3 по подразбиране (не 1)", lb.ТАВАН_СДЕЛКИ == 3)
...
ck("П98 три отворени → слот НЯМА", _слот98({"x": 1}, 2, 3) is False)
