...
DAY["sma200"] = DAY["close"].rolling(200).mean()
...
print()
print("=" * 96)
print("F25 · ОТСКОК ОТ ПЪЛЗЯЩА СРЕДНА · доставената геометрия, реален спред от лентата")
print("=" * 96)
...
json.dump(изход, io.open("F25_ma.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
print()
